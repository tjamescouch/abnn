//
//  positional-encoding-layer.h
//  MetalNeuron
//
//  Created by James Couch on 2025-03-13.
//

#ifndef POSITIONAL_ENCODING_LAYER_H
#define POSITIONAL_ENCODING_LAYER_H

#include "layer.h"

class PositionalEncodingLayer : public Layer {
public:
    PositionalEncodingLayer(int embeddingDim, int sequenceLength, int outputDim, int batchSize);
...
private:
    ...
    MTL::Buffer* positionalEncodingBuffer_;
